...
<link href="pastListStyle.css" type="text/css" rel="stylesheet" />
...
<body class="body">
	...
	<div>
		<img src="Images/PastGamesTitle.png">
	</div>
	<div id="container">
		<div id="content" class="collegeFont">
			</br>
			<a href="CoachEditGameView.php" class="displayBlock">
			<div class="gameBack">
				<p class="gameInfo">	
				APRIL 6 - UNLV </br>
				7-3 WIN
		...
		<div id="footer">
			<a href='CoachMenu.php'><img src="Images/BackButtonDone.png"></a>
		</div>
	</div>
</body>
</html>